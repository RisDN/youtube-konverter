...
function hiba(hibakod) {
    if (hibakod == 0) {
        hibaU('Kérlek egy videó linkjét írd be!');
        link_doboz.value = null
    }
    if (hibakod == 1) { hibaU('Kérlek válassz letöltési helyet!') }
    if (hibakod == 3) { hibaU('Kérlek válassz formátumot!') }
}
